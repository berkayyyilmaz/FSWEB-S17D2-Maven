...
public class DeveloperController {
    ...
    public void init() {
        ...
        this.developers.put(1, new SeniorDeveloper(1, "Berkay", 1000d));
    }
    ...
    public DeveloperResponse save(@RequestBody Developer developer){
        ...
        if (Objects.nonNull(createdDeveloper)) { //eşit değil null da yapılabilirdi, bu da bir yöntem.
            developers.put(createdDeveloper.getId(), createdDeveloper);
        }
        return new DeveloperResponse(createdDeveloper, HttpStatus.CREATED.value(),"crate işlemi başarılı");
    }
